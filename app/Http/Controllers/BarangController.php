...
class BarangController extends Controller
{
    ...
    // Menampilkan form tambah barang (AJAX)
    ...
    public function store_ajax(Request $request)
    {
        if ($request->ajax() || $request->wantsJson()) {
            $rules = [
                'kategori_id'  => 'required|integer',
                'barang_kode'  => 'required|string|min:3|max:50|unique:m_barang,barang_kode',
                'barang_nama'  => 'required|string|min:3|max:100|unique:m_barang,barang_nama',
    ...
    public function update_ajax(Request $request, $id)
    {
        if ($request->ajax() || $request->wantsJson()) {
            ...
            'barang_kode' => 'required|string|min:3|max:50',
            'harga_beli'  => 'required|numeric|min:0',
            'harga_jual'  => 'required|numeric|min:0'
            ];
    ...
    public function export_pdf()
    {
        ...
        // Paksa download dengan header
        return response($pdf->output(), 200, [
            'Content-Type' => 'application/pdf',
            'Content-Disposition' => 'attachment; filename="Data Barang ' . date('Y-m-d_H-i-s') . '.pdf"',
        ]);
    }
